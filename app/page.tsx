...
const FEATURES = [
  {
    icon: '📚',
    title: 'مكتبة مفتوحة',
    body: 'عروض فيزياء وملخصات وأوراق عمل جاهزة للتحميل — كثير منها مجاني للجميع.',
  },
  {
    icon: '🎯',
    title: 'مبنية على منهج الفيزياء',
    body: 'كل ملف مربوط بوحدة محددة من منهج IGCSE، مو مواد عامة منقولة من الإنترنت.',
  },
  {
    icon: '🧑‍🏫',
    title: 'حصص خصوصية',
    body: 'تبي شرح مباشر؟ احجز حصة فيزياء أونلاين أو حضورياً مع نفس المعلمة اللي أعدّت المواد.',
  },
  {
    icon: '🤝',
    title: 'شبكة معلمين',
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <h2>مكتبة فيزياء تتعلم منها… ومعلمة توصلك للدرجة</h2>
